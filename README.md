...
2. Click [Install](https://github.com/Ponkhy/Pipention/raw/main/pipention.user.js) here
### Alternative:
1. Open the **pipention.user.js** script in this repo.
...
---
### Known Issues
- Menu options popping up for a split second